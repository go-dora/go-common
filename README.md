...
- [其他功能举例](#%E5%85%B6%E4%BB%96%E5%8A%9F%E8%83%BD%E4%B8%BE%E4%BE%8B)
  ...
  - [测试 PostJson 请求](#%E6%B5%8B%E8%AF%95postjson%E8%AF%B7%E6%B1%82)
  - [测试 Get 请求](#%E6%B5%8B%E8%AF%95get%E8%AF%B7%E6%B1%82)
  - [测试 Post 请求](#%E6%B5%8B%E8%AF%95post%E8%AF%B7%E6%B1%82)
  ...
  - [测试 mysql 普通 sql](#%E6%B5%8B%E8%AF%95mysql%E6%99%AE%E9%80%9Asql)
  - [测试 Gorm](#%E6%B5%8B%E8%AF%95gorm)
  - [测试 redis 查询](#%E6%B5%8B%E8%AF%95redis%E6%9F%A5%E8%AF%A2)
...
项目地址：https://github.com/go-dora/go-common
...
```
go get -v github.com/go-dora/go-common
```

2. 将配置文件拷贝到你的项目中，配置文件请参考：https://github.com/go-dora/go-common/tree/master/conf/dev
   可以通过 InitModule("配置地址","模块数组") 方法按模块需加载配置。

- base：包含日志和系统时间配置等
- mysql：包含 mysql 操作方法和日志
- redis：包含 redis 操作方法和日志
...
**怎么样才能让类库做的更通用？**
有人说简洁才是 golang 特性，不需要做通用类库。如果你想加一个功能直接引一个包用即可。比如：日志那就引日志包、redis 就引 redis 包。
...
你的 star ，我的动力。有任何关于类库的问题，请提交 issue，谢谢。
